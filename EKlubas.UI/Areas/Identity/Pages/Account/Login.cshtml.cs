...
namespace EKlubas.UI.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<EKlubasUser> signInManager, 
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _logger.LogInformation("Naudotojas prijungtas.");
                ...
                {
                    _logger.LogWarning("Naudotojo paskyra užblokuota.");
                    return RedirectToPage("./Lockout");
                }
                else
                {
                    ModelState.AddModelError(string.Empty, "Neteisingas bandymas prisijungti.");
                    return Page();
                }
            }
